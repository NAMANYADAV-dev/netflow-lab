...
const nodes: Record<string, Node> = {
  ...
  rt: { x: 368, y: 78, w: 168, h: 130, label: 'ROUTER / GATEWAY', sub: 'NAT + PAT', kind: 'router', color: B },
  isp: { x: 596, y: 118, w: 110, h: 52, label: 'ISP', sub: 'internet', kind: 'cloud', color: 'var(--text2)' },
  web: { x: 766, y: 96, w: 150, h: 96, label: 'WEB SERVER', sub: '203.0.113.20', kind: 'server', color: B },
};
