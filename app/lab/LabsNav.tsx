...
/* The labs' own navbar. LabsHeader wraps it on the server so that the search
   palette's index — which is built from records that carry every page's prose —
   is read there rather than imported into this client bundle.
